 ...
 public class StudentE : Person
  {
    ...
    public TeacherE CourseworkTeacher { get; set; }
    public int EntityType { get; set; }
    public string Title { get; set; }
    public string URLToAvatar { get; set; }

    public StudentE(string firstName, string secondName, string middleName, string gender, string birthDate, bool priveleges,
      ...
      string title, string urlToAvatar) : base(firstName, secondName, middleName)
    {
      ...
      CourseworkTeacher = new TeacherE(teachersFirstName, teachersSecondName, teachersMiddleName);
